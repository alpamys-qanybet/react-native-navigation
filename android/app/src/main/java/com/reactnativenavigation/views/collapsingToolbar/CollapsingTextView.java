...
import androidx.annotation.CheckResult; // import android.support.annotation.CheckResult;
import androidx.annotation.FloatRange; // import android.support.annotation.FloatRange;
import androidx.core.widget.TextViewCompat; // import android.support.v4.widget.TextViewCompat;
import androidx.appcompat.widget.TintTypedArray; // import android.support.v7.widget.TintTypedArray;
